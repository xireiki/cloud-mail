const en = {
    ...
    federationSiteManagement: 'Federation Site Management',
    addFederationSite: 'Add Federation Site',
    editFederationSite: 'Edit Federation Site',
    domain: 'Domain',
    siteName: 'Site Name',
    symmetricKey: 'Key',
    ...
    inputDomain: 'Please enter domain',
    inputSiteName: 'Please enter site name',
    inputSymmetricKey: 'Please enter key',
    inputApiDomain: 'Please enter API domain (optional)',
    generateKey: 'Generate Key',
    validateKey: 'Validate Key',
    symmetricKeyTips: 'Key must be a 64-character hexadecimal string (32 bytes)',
    mySiteKey: 'My Site Key',
    mySiteKeyTips: 'This site\'s key for federation communication',
    editMySiteKey: 'Edit My Site Key',
    notSet: 'Not set',
    keyNotSet: 'Key not set, please set or generate a key first',
    apiDomainTips: 'If API domain is not provided, email domain will be used as API domain',
    domainRequired: 'Domain is required',
    domainInvalid: 'Invalid domain format',
    symmetricKeyRequired: 'Key is required',
    symmetricKeyInvalid: 'Invalid key format, must be 64-character hexadecimal string',
    confirmDeleteFederationSite: 'Are you sure to delete federation site "{domain}"?',
    warning: 'Warning',
    confirm: 'Confirm',
    cancel: 'Cancel',
    deleteSuccess: 'Delete successful',
    deleteFailed: 'Delete failed',
    generateKeySuccess: 'Key generated successfully',
    generateKeyFailed: 'Key generation failed',
    inputKeyFirst: 'Please enter key first',
    keyValid: 'Key format is valid',
    keyInvalid: 'Key format is invalid',
