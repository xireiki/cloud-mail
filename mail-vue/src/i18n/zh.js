const zh = {
    ...
    userEmail: '用户邮箱',
    // 联邦邮局管理
    federationSiteManagement: '联邦邮局管理',
    addFederationSite: '添加联邦邮局',
    editFederationSite: '编辑联邦邮局',
    domain: '域名',
    siteName: '站点名称',
    symmetricKey: '密钥',
    apiDomain: 'API域名',
    ...
    inputSymmetricKey: '请输入密钥',
    inputApiDomain: '请输入API域名（可选）',
    generateKey: '生成密钥',
    validateKey: '验证密钥',
    symmetricKeyTips: '密钥必须是64个字符的十六进制字符串（32字节）',
    apiDomainTips: '如果不填写API域名，将使用邮箱域名作为API域名',
    domainRequired: '域名不能为空',
    domainInvalid: '域名格式不正确',
    symmetricKeyRequired: '密钥不能为空',
    symmetricKeyInvalid: '密钥格式不正确，必须是64个字符的十六进制字符串',
    confirmDeleteFederationSite: '确定要删除联邦邮局站点 "{domain}" 吗？',
    warning: '警告',
    confirm: '确定',
    cancel: '取消',
    deleteSuccess: '删除成功',
    deleteFailed: '删除失败',
    generateKeySuccess: '密钥生成成功',
    generateKeyFailed: '密钥生成失败',
    inputKeyFirst: '请先输入密钥',
    keyValid: '密钥格式正确',
    keyInvalid: '密钥格式不正确',
    validateFailed: '验证失败',
    copySuccess: '复制成功',
    ...
    // 本站密钥
    mySiteKey: '本站密钥',
    mySiteKeyTips: '本站密钥用于与其他联邦邮局通信，需要与其他站点配置相同的密钥',
